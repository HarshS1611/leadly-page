...
export default function Navbar() {
    ...
    return (
        <div className="">
            <div className="max-w-7xl mx-auto p-2 sm:px-6 lg:px-20">
                <div className="relative flex items-center gap-5 mt-2 justify-between">
                    ...
                    <div className="flex items-center px-2 lg:px-0 xl:w-full">
                        ...
                        <div className="hidden lg:block lg:ml-6">
                            <div className="flex gap-2 text-lg  items-center mt-5 ml-5 space-x-4">
                    ...
                    <div className="hidden lg:block ">
                        <div className="flex items-center">
                            ...
                            <button className="bg-[#7db434] text-white w-max py-2 rounded-full px-4">CONTACT US</button>
                            </div>
